...
<div class="row">
  <div class="col-md-12">
    <div class="card">
            ...
            <form class="form-horizontal" method="post" action="  <?php echo e(route('user.store')); ?> ">
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control <?php echo e($errors->first('name') ? 'is-invalid' : ''); ?> " name="name" id="name" placeholder="Nama" value="<?php echo e(old('name')); ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control <?php echo e($errors->first('email') ? 'is-invalid' : ''); ?> " id="email" name="email" placeholder="Email" value="<?php echo e(old('email')); ?>">
                    <div class="invalid-feedback">
      ...
      <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts_admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp74\htdocs\penjualanapp\resources\views/user/create.blade.php ENDPATH**/ ?>