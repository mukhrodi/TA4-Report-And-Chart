                        ...
                        <form class="form-horizontal" method="post" action="  {{ route('pegawai.update',$pegawai->username) }} "  >
                          ...
                          <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control {{ $errors->first('username') ? 'is-invalid' : '' }} "  id="username" placeholder="Nama Supplier" value="{{ $pegawai->username }}" disabled >
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control {{ $errors->first('nama_pegawai') ? 'is-invalid' : '' }} " name="nama_pegawai" id="nama_pegawai" placeholder="Nama Supplier" value="{{ $pegawai->nama_pegawai }}" >
                                <div class="invalid-feedback">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="jk" id="jk" class="form-control {{ $errors->first('jk') ? 'is-invalid' : '' }}">
                                         <option value="PRIA" {{ $pegawai->jk == 'PRIA' ? 'selected' : '' }} >PRIA</option>
                                         <option value="WANITA" {{ $pegawai->jk == 'WANITA' ? 'selected' : '' }} >WANITA</option>
                                    </select>
                                    {{ $errors->first('jk') }}
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <label for="alamat" class="col-sm-2 col-form-label">Alamat</label>
                                    <div class="col-sm-10">
                                    <textarea  name="alamt" id="alamt" class="form-control {{ $errors->first('alamt') ? 'is-invalid' : '' }} " cols="30" rows="4" placeholder="Alamat">{{ $pegawai->alamt }}</textarea>
                                        <div class="invalid-feedback">
                                            {{ $errors->first('alamt') }}
                                    </div>
                                </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="is_aktif" id="is_aktif" class="form-control {{ $errors->first('is_aktif') ? 'is-invalid' : '' }}">
                                         ...
                                         <option value="0" {{ $pegawai->is_aktif == '0' ? 'selected' : '' }} >Tidak Aktif</option>
                                    </select>
