                        ...
                        <form class="form-horizontal" method="post" action="  {{ route('supplier.update',$supplier->kd_supplier) }} ">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control {{ $errors->first('nama_supplier') ? 'is-invalid' : '' }} " name="nama_supplier" id="nama_supplier" placeholder="Nama Supplier" value="{{ $supplier->nama_supplier }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="alamat_supplier" id="alamat_supplier" class="form-control {{ $errors->first('alamat_supplier') ? 'is-invalid' : '' }} " cols="30" rows="4" placeholder="Alamat Supplier">{{ $supplier->alamat_supplier }}</textarea>
                                        <div class="invalid-feedback">
